...
This screenshot shows the alert summary page with one high-severity alert generated by the custom rule.

![Custom SSH Brute Force Alert](image/custom-ssh-bruteforce-alert.png)

### Alert Detail Evidence

This screenshot shows the generated alert details, including the threshold rule type, alert severity, risk score, source IP, and threshold count.
